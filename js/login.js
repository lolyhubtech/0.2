...
/****** login and signup width change *******/
$('.login').click(function(){
    $('.nav-tabs>li.signup').css('width','30%'); 
    $('.nav-tabs>li.login').css('width','70%'); 
});

$('.signup').click(function(){
    $('.nav-tabs>li.signup').css('width','70%'); 
    $('.nav-tabs>li.login').css('width','30%'); 
});
